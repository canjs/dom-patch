...
/*dom-patch@2.1.6#src/patch/patch-options*/
define('dom-patch/src/patch/patch-options', function (require, exports, module) {
    exports.collapseTextNodes = false;
});
/*dom-patch@2.1.6#src/scheduler*/
define('dom-patch/src/scheduler', [
    'require',
    'exports',
    'module',
    'node-route',
    'dom-patch/src/patch/patch-options'
...
/*dom-patch@2.1.6#src/overrides/util/mark_in_document*/
...
/*dom-patch@2.1.6#src/overrides/insert*/
define('dom-patch/src/overrides/insert', [
    'require',
    'exports',
    'module',
    'dom-patch/src/scheduler',
    'node-route',
    'dom-patch/src/overrides/util/mark_in_document',
    'dom-patch/src/overrides/util/in_document',
    'dom-patch/src/patch/patch-options',
    ...
    module.exports = function (Node) {
        ...
        proto.insertBefore = function (child, ref) {
            var refIndex = nodeRoute.indexOfParent(this, ref, patchOpts.collapseTextNodes ? nrOptions : void 0);
        ...
        proto.replaceChild = function (newChild, oldChild) {
            var refIndex = nodeRoute.indexOfParent(this, oldChild, patchOpts.collapseTextNodes ? nrOptions : void 0);
...
/*dom-patch@2.1.6#src/overrides/remove*/
define('dom-patch/src/overrides/remove', [
    'require',
    'exports',
    'module',
    'dom-patch/src/scheduler',
...
/*dom-patch@2.1.6#src/overrides/attributes*/
define('dom-patch/src/overrides/attributes', [
    'require',
    'exports',
    'module',
    'dom-patch/src/scheduler',
...
/*dom-patch@2.1.6#src/overrides/prop*/
define('dom-patch/src/overrides/prop', [
    'require',
    'exports',
    'module',
    'dom-patch/src/scheduler',
...
/*dom-patch@2.1.6#src/overrides/events*/
define('dom-patch/src/overrides/events', [
    'require',
    'exports',
    'module',
    'dom-patch/src/scheduler',
...
/*dom-patch@2.1.6#src/overrides/history*/
define('dom-patch/src/overrides/history', [
    'require',
    'exports',
    'module',
    'dom-patch/src/scheduler'
...
/*dom-patch@2.1.6#src/patch/patch*/
define('dom-patch/src/patch/patch', [
    'require',
    'exports',
    'module',
    'dom-patch/src/patch/patch-options',
    'dom-patch/src/scheduler',
    'dom-patch/src/overrides/util/mark_in_document',
    'dom-patch/src/overrides/insert',
    'dom-patch/src/overrides/remove',
    'dom-patch/src/overrides/attributes',
    'dom-patch/src/overrides/prop',
    'dom-patch/src/overrides/events',
    'dom-patch/src/overrides/history'
], function (require, exports, module) {
...
/*dom-patch@2.1.6#src/patch*/
define('dom-patch', [
    'require',
    'exports',
    'module',
    'dom-patch/src/patch/patch'
], function (require, exports, module) {
